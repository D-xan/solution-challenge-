...
class UserPostsRecord extends FirestoreRecord {
  ...
  // "likenumbers" field.
  int? _likenumbers;
  int get likenumbers => _likenumbers ?? 0;
  bool hasLikenumbers() => _likenumbers != null;
  ...
  void _initializeFields() {
    ...
    _likenumbers = castToType<int>(snapshotData['likenumbers']);
  }
