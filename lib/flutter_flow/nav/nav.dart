      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => StoryDetailsWidget(
            initialStoryIndex: params.getParam('initialStoryIndex',
                ParamType.DocumentReference, false, ['userStories']),
          ),
        ),
        FFRoute(
          name: 'editSettings',
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/HD-wallpaper-gojo-neon-black-jjk-simple-anime.jpg',
